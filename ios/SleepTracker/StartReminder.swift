...
enum StartReminder {
    ...
    static var time: DateComponents {
        get {
            ...
            return DateComponents(hour: d.object(forKey: hourKey) as? Int ?? 22,
                                  minute: d.object(forKey: minuteKey) as? Int ?? 30)
        }
        set {
    ...
    static func reschedule(skippingTonight: Bool = false) {
        ...
        guard var next = cal.nextDate(after: Date(), matching: target,
